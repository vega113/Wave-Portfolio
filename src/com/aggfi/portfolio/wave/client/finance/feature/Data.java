...
public class Data extends JsArrayString{
	...
	public final String toStringMy() {
		return "Data [getChange()=" + getChange() + ", getChangePercentage()="
				+ getChangePercentage() + ", getExchange()=" + getExchange()
				+ ", getExtVolume()=" + getExtVolume() + ", getHigh()="
				+ getHigh() + ", getLast()=" + getLast()
				+ ", getLastTradeTime()=" + getLastTradeTime() + ", getLow()="
				+ getLow() + ", getOpen()=" + getOpen() + ", getSymbol()="
				+ getSymbol() + ", getVolume()=" + getVolume() + "]";
	}
	...
	public final native String getExchange() /*-{ return this[google.finance.EXCHANGE]; }-*/;
	  ...
	  public final native String getLastTradeTime() /*-{ return this[google.finance.LAST_TRADE_DATE]; }-*/;
